...
from fashion_seqref.src.metrics import mse as _mse, psnr as _psnr, fwd_rel as _fwd_rel
from fashion_seqref.src.train_utils import setup_logger, write_json
from fashion_seqref.scripts.train_base import _build, _posterior_pixel_mean

logger = setup_logger("fashion_seqref.check_conditioning")
__version__ = "0.1"
_N_POST = 16
...
def main():
    ...
    out = args.out or os.path.join("./fashion_seqref/results/_diag",
