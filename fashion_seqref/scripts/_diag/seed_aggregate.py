...
logger = logging.getLogger("fashion_seqref.seed_aggregate")
...
def _spread_check(run_dir: str, n_post: int = 16, batch: int = 64) -> float:
    ...
    from fashion_seqref.src.refiners.base_io import FrozenBase, refiner_inputs
    from fashion_seqref.src.refiners.coupling_regressor import CplRegRefiner
    import yaml
    ...
    with torch.no_grad():
        ...
        draws = []
        from fashion_seqref.src.degrade import inverse_logit
