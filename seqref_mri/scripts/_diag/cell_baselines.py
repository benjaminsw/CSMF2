...
from seqref_mri.src.metrics import psnr as _psnr, fwd_rel as _fwd_rel
from seqref_mri.src.train_utils import setup_logger

logger = setup_logger("seqref_mri.cell_baselines")
...
def main():
    ...
    ap.add_argument("--data-root", default="./seqref_mri/data")
    ...
    ap.add_argument("--out", default=None,
                    help="default: results/_diag/cell_baselines_s<scale>_"
                         "n<noise>.json under ./seqref_mri")
    args = ap.parse_args()
    out_path = args.out or (f"./seqref_mri/results/_diag/cell_baselines_"
