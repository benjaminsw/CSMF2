...
from seqref_mri.src.degrade import MNISTDegraded, dequantize_logit
from seqref_mri.src.metrics import mse as _mse, psnr as _psnr, fwd_rel as _fwd_rel
from seqref_mri.src.train_utils import setup_logger, write_json
from seqref_mri.scripts.train_base import _build, _posterior_pixel_mean

logger = setup_logger("seqref_mri.check_conditioning")
__version__ = "0.1"
_N_POST = 16
...
def main():
    ...
    out = args.out or os.path.join("./seqref_mri/results/_diag",
