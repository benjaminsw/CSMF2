# =============================================================================
# STEP-1_1 v0.1 -- models.flows.glow.glow_step
# Purpose: one Glow step (paper Fig. 2a) = Actnorm -> InvertibleConv1x1 ->
#          AffineCoupling2D. ldj accumulates across the three sub-layers.
# CONVENTION: any non-finite -> logger.error + raise.
# Changelog (NEW in v0.1):
#   * Introduced as part of glow_improved -> shared merge. Thin composer.
# Update summary:
#   The composer exists so CondGlow can hold a flat list of GlowStep modules
#   and so the actnorm-init walker can iterate over them.
# =============================================================================
