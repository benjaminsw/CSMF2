# Step 4 -- WP3 MNIST ablation matrix
...
```
python -m CSMF2.experiments.step_4.run --seed 0
python -m CSMF2.experiments.step_4.run --seed 1
python -m CSMF2.experiments.step_4.run --seed 2
```
...
One default config selected; matched/better NLL + improved residual/geometry.
