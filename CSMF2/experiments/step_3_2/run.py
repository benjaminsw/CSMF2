# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_3_2.run
# Purpose: Entry point for step 3.2 -- Stage B full hybrid (experts frozen) (WP2)
...
STEP_ID = "3.2"
STEP_NAME = "Stage B full hybrid (experts frozen)"
WP = "WP2"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 3.2: training/eval not implemented")
    raise NotImplementedError(
        "step 3.2: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 3.2 -- Stage B full hybrid (experts frozen)")
