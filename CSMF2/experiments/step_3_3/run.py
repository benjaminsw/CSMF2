# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_3_3.run
# Purpose: Entry point for step 3.3 -- Stage C light joint fine-tune (WP2)
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 3.3: training/eval not implemented")
    raise NotImplementedError(
        "step 3.3: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 3.3 -- Stage C light joint fine-tune")
