# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_1_3.run
# Purpose: Entry point for step 1.3 -- Expert sanity package (pre-Stage B) (WP0)
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 1.3: training/eval not implemented")
    raise NotImplementedError(
        "step 1.3: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 1.3 -- Expert sanity package (pre-Stage B)")
