# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_6.run
# Purpose: Entry point for step 6 -- Final sweep (lambda_cons, T, tau) (WP5)
...
STEP_ID = "6"
STEP_NAME = "Final sweep (lambda_cons, T, tau)"
WP = "WP5"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 6: training/eval not implemented")
    raise NotImplementedError(
        "step 6: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 6 -- Final sweep (lambda_cons, T, tau)")
