# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_5_1.run
# Purpose: Entry point for step 5.1 -- Port to optical SR (DIV2K / BSD68) (WP4)
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 5.1: training/eval not implemented")
    raise NotImplementedError(
        "step 5.1: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 5.1 -- Port to optical SR (DIV2K / BSD68)")
