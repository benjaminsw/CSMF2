# Step 2.2 -- Proximal step at inference only
...
```
python -m CSMF2.experiments.step_2_2.run --seed 0
python -m CSMF2.experiments.step_2_2.run --seed 1
python -m CSMF2.experiments.step_2_2.run --seed 2
```
...
Smallest T with clear residual drop + acceptable NLL/recon tradeoff.
