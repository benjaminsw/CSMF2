# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_2_2.run
# Purpose: Entry point for step 2.2 -- Proximal step at inference only (WP1)
...
STEP_ID = "2.2"
STEP_NAME = "Proximal step at inference only"
WP = "WP1"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 2.2: training/eval not implemented")
    raise NotImplementedError(
        "step 2.2: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 2.2 -- Proximal step at inference only")
