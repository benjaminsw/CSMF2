# Step 1.2 -- Mixture skeleton (pure NLL)
...
```
python -m CSMF2.experiments.step_1_2.run --seed 0
python -m CSMF2.experiments.step_1_2.run --seed 1
python -m CSMF2.experiments.step_1_2.run --seed 2
```
...
Learned gate no worse than uniform; gate usage varies across inputs.
