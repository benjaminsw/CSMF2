# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_1_2.run
# Purpose: Entry point for step 1.2 -- Mixture skeleton (pure NLL) (WP0)
...
STEP_ID = "1.2"
STEP_NAME = "Mixture skeleton (pure NLL)"
WP = "WP0"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 1.2: training/eval not implemented")
    raise NotImplementedError(
        "step 1.2: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 1.2 -- Mixture skeleton (pure NLL)")
