# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_3_1.run
# Purpose: Entry point for step 3.1 -- Stage A with weak consistency (WP2)
...
STEP_ID = "3.1"
STEP_NAME = "Stage A with weak consistency"
WP = "WP2"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 3.1: training/eval not implemented")
    raise NotImplementedError(
        "step 3.1: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 3.1 -- Stage A with weak consistency")
