# Step 3.1 -- Stage A with weak consistency
...
```
python -m CSMF2.experiments.step_3_1.run --seed 0
python -m CSMF2.experiments.step_3_1.run --seed 1
python -m CSMF2.experiments.step_3_1.run --seed 2
```
...
Weak consistency helps or does not hurt expert health.
