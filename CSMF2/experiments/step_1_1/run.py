# =============================================================================
# EXP-SCAFFOLD v2.2 -- experiments.step_1_1.run
# Purpose: Entry point for step 1.1 -- Single conditional expert (no mixture) (WP0)
...
STEP_ID = "1.1"
STEP_NAME = "Single conditional expert (no mixture)"
WP = "WP0"
...
def run(seed, cfg_overrides=None):
    ...
    """
    logger.error("[run] step 1.1: training/eval not implemented")
    raise NotImplementedError(
        "step 1.1: wire training/eval here; call append_row() + update_status() on progress"
    )


def main(argv=None):
    ap = argparse.ArgumentParser(description="step 1.1 -- Single conditional expert (no mixture)")
