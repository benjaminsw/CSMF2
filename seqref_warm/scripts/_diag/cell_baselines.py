...
from seqref_warm.src.metrics import psnr as _psnr, fwd_rel as _fwd_rel
from seqref_warm.src.train_utils import setup_logger

logger = setup_logger("seqref_warm.cell_baselines")
...
def main():
    ...
    ap.add_argument("--data-root", default="./seqref_warm/data")
    ...
    ap.add_argument("--out", default=None,
                    help="default: results/_diag/cell_baselines_s<scale>_"
                         "n<noise>.json under ./seqref_warm")
    args = ap.parse_args()
    out_path = args.out or (f"./seqref_warm/results/_diag/cell_baselines_"
