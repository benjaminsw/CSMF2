...
logger = logging.getLogger("seqref_warm.seed_aggregate")
...
def _spread_check(run_dir: str, n_post: int = 16, batch: int = 64) -> float:
    ...
    from seqref_warm.src.refiners.base_io import FrozenBase, refiner_inputs
    ...
    with torch.no_grad():
        ...
        draws = []
        from seqref_warm.src.degrade import inverse_logit
